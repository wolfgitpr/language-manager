...
namespace LangPlugins {
    ...
    public:
        ...
        virtual LangMgr::NO<ITensor> clone() const = 0;
    };
...
#undef LANGPLUGINS_TENSOR_REGISTER_DATATYPE
    ...
    public:
        ...
        ///
        /// \return On success: A new Tensor wrapped in `LangMgr::NO`.
        ...
        template <typename T>
        static LangMgr::Expected<LangMgr::NO<Tensor>> createScalar(T value, bool zeroDimensions = false);
