#ifndef LANGPLUGINS_ONNXDRIVER_SCOPEDTIMER_H
#define LANGPLUGINS_ONNXDRIVER_SCOPEDTIMER_H
...
namespace LangPlugins::onnxDriver
{
    ...
    public:
        ...
        ~ScopedTimer() {
            ...
            const auto elapsed = std::chrono::duration_cast<duration_t>(std::chrono::steady_clock::now() - m_timeStart);
            m_callback(elapsed);
        }
