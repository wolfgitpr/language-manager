...
namespace LangPlugins
{
    ...
    LangCore::Expected<LangCore::NO<OnnxTensor>> OnnxTensor::create(DataType dataType,
                                                                    const std::vector<int64_t> &shape) {
    ...
    LangCore::Expected<LangCore::NO<OnnxTensor>>
    ...
    LangCore::NO<ITensor> OnnxTensor::clone() const {
