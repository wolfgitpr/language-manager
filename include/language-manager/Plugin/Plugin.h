...
namespace LangMgr
{
    ...
    public:
        static void registerStaticPlugin(const char *pluginSet, StaticPlugin plugin);
    };

} // namespace LangMgr

#define LANGUAGE_MANAGER_EXPORT_PLUGIN(PLUGIN_NAME)                                                                    \
    extern "C" STDCORELIB_DECL_EXPORT LangMgr::Plugin *synthrt_plugin_instance() {                                     \
        static PLUGIN_NAME _instance;                                                                                  \
        return &_instance;                                                                                             \
    }

#define LANGUAGE_MANAGER_EXPORT_STATIC_PLUGIN(PLUGIN_NAME, PLUGIN_SET)                                                 \
    struct initializer {                                                                                               \
        initializer() {                                                                                                \
